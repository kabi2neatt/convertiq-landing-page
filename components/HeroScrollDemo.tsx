...
const WEBSITE_DEMO_FORM_URL = "https://form.typeform.com/to/RfPVmTyx";
const GOOGLE_META_AUDIT_FORM_URL = "https://form.typeform.com/to/ZQ29PRZp";
      ...
      <div className="relative z-20 flex h-full flex-col items-center justify-start px-4 pt-[8.75rem] text-center md:justify-center md:px-6 md:pt-0">
        ...
        >
          ...
          >
            ...
            <HeroButton href={WEBSITE_DEMO_FORM_URL} variant="blue">
              Get Free Website Demo ↗
            </HeroButton>

            <HeroButton href={GOOGLE_META_AUDIT_FORM_URL} variant="purple">
