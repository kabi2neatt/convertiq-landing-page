...
const TYPEFORM_IDS = {
  demo: "01KSQJAJ1JXK6KVE158NNMTJ78",
  audit: "01KSQJC2H74B0VEW8923KGJQZ0",
};
        ...
        >
          ...
          >
            <div className="h-full overflow-y-auto p-3 pb-24 md:p-5 md:pb-28">
              <div
                key={`${type}-${TYPEFORM_IDS[type]}`}
                data-tf-live={TYPEFORM_IDS[type]}
                className="min-h-[760px] w-full rounded-2xl bg-black"
              />
            </div>
          </motion.div>
        </motion.div>
